...
public class NewsController {
    ...
    public String showNews(@RequestParam (required = false) Double price,
        ...
        model.addAttribute("cateogory", newsCategoryService.listAll());
    ...
    public String showAdd(Model model) {
        model.addAttribute("newscategorys", newsCategoryService.listAll());
        model.addAttribute("types", NewsType.values());
        return "form";
    }
    ...
    public String showEdit(@PathVariable (required = false) Long id, Model model) {
        model.addAttribute("newscategorys", newsCategoryService.listAll());
        model.addAttribute("types", NewsType.values());
        model.addAttribute("news", service.findById(id));
        return "form";
    }

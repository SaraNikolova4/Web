...
public class CandidatesController {
    ...
    public String showCandidates(@RequestParam (required = false) Integer years,
        ...
        if (years == null && gender == null) {
            candidateList = this.candidateService.listAllCandidates();
        } else {
            candidateList = this.candidateService.listCandidatesYearsMoreThanAndGender(years, gender);
        }
        model.addAttribute("candidati", candidateList);
        model.addAttribute("parti", partyService.listAll());
    ...
    public String showEdit(@PathVariable  Long id, Model model) {
        model.addAttribute("parti", partyService.listAll());
        model.addAttribute("Gender", Gender.values());
        model.addAttribute("kadidat", this.candidateService.findById(id));
        return "form";
    }
